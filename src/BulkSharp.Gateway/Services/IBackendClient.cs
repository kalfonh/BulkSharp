...
public interface IBackendClient
{
    ...
    Task<HttpResponseMessage> PostRetryAsync(Guid id, CancellationToken ct = default);
    Task<HttpResponseMessage> PostRetryRowsAsync(Guid id, HttpContent body, CancellationToken ct = default);
