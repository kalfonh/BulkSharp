...
internal static partial class LogMessages
{
    ...
    [LoggerMessage(Level = LogLevel.Warning, Message = "Source parameter '{Source}' does not match any registered backend. Falling back to fan-out.")]
    public static partial void SourceBackendNotFound(this ILogger logger, string source);
}
